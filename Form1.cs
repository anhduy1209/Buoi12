...
namespace WindowsFormsApplication1
{
    public partial class Form1 : Form
    {
        ...
        public void Them(string S,string T,string SN,string P)
        {
            try
            {
                connect = new SqlConnection(a);
                connect.Open();
                string InsertString = "insert into HoiNghi Values('" + S + "' ,' " + T + "','"+SN+"','"+P+"')";
        ...
        public void Xoa(string S,string Ta)
        {
            try
            {
                ...
                connect = new SqlConnection(a);
                connect.Open();
                string DeleteString = "delete HoiNghi where maHoiNghi = '" + S + "'";
        ...
        {
            Them(textBox1.Text, textBox2.Text, textBox3.Text,comboBox1.Text);
        }
